...
### 为何要写这个组件
一直以来都有记笔记的习惯，但是之前都是在自己电脑上做记录，有时候在手机想查看很不方便，再加上自己word水平巨菜以及代码放在word中实在不美观的缘故，每次记笔记都感觉吃力不讨好，后来接触markdown，才发现原来记笔记还能这么简单。但是随着自己记录的内容越来越多，越来越感觉有时候一图胜千言，但是找了一圈感觉带图片上传的云笔记貌似就没免费的😂。算了，刚好有点时间，没有就自己先写一个编辑吧，等写完了自己的系统上用:grimacing:。
...
```
#### 我该如何了解插件语法？
打开项目根目录下的test.txt,讲其拷贝到编辑区，对比右侧看到的预览文本，就能知道如何使用了
